...
const mytmplt kModules[MAXMODULE] PROGMEM = {
  ...
  { "Sonoff T1 2CH",   // Sonoff T1 2CH (ESP8285)
     ...
     GPIO_USER,        // GPIO02 Optional Sensor (J3 Pin 5)
     GPIO_USER,        // GPIO03 Serial TXD and Optional sensor
     GPIO_USER,        // GPIO04 AF - Option IR sensor (D2)
     GPIO_REL2,        // GPIO05 Blue Led and Relay 2 (0 = Off, 1 = On)
     0, 0, 0,          // Flash connection
     GPIO_KEY2,        // GPIO09 Button 2
     0,                //GPIO 10 - Bổ xung thêm cho phím bấm ảo (Ko relay) == Khong thay co y nghia
     0,                // Flash connection
     GPIO_REL1,        // GPIO12 Blue Led and Relay 1 (0 = Off, 1 = On)
     GPIO_LED1_INV,    // GPIO13 Blue Led (0 = On, 1 = Off)
     0, 0, 0, 0
  ...
  { "Generic Wemos",         // Any ESP8266/ESP8285 device like WeMos and NodeMCU hardware (ESP8266)
   ...
   { "GM SW4CH V1.0",       // Bộ sitch không dây GAMMA 4Ch _Ver.1 (NodeMCU ESP-12E) Out 14 12 13 3  In 2 4 5 1
     0,        // GPIO00 Button 1 //Trùng GPIO2
     GPIO_KEY4,        // GPIO_KEY4 - GPIO01 Button 4 //Ngắt để có Serial RXD and Optional sensor & Debug NodeMCU
     GPIO_KEY1,        // GPIO02 Button 1
     GPIO_REL4,        // GPIO03 Relay 4
     GPIO_KEY2,        // GPIO04 Button 2
     GPIO_KEY3,        // GPIO05 Button 3
     0, 0, 0,          // Flash connection (6, 7, 8)
     0, 0, 0,          // 9, 10,11
     GPIO_REL2,        // GPIO12 Relay 2
     GPIO_REL3,        // GPIO13 Relay 3
     GPIO_REL1,        // GPIO14 Relay 1
     GPIO_LED1_INV,    // GPIO15 Blue Led trạng thái (0 = On, 1 = Off)
     0,0
  },
  { "MD SW4CH V1.0",  // Switch 04Ch - Minh Duyen (ESP8286)
     GPIO_KEY1,        // GPIO00 Button 1
     GPIO_USER,        // GPIO01 Serial RXD and Optional sensor
     GPIO_KEY2,        // GPIO02 Optional sensor
     GPIO_USER,        // GPIO03 Serial TXD and Optional sensor
     GPIO_REL3,        // GPIO04 Sonoff 4CH Red Led and Relay 3 (0 = Off, 1 = On)
     GPIO_REL2,        // GPIO05 Sonoff 4CH Red Led and Relay 2 (0 = Off, 1 = On)
     0, 0, 0,          // Flash connection
     0,        // GPIO09 Button 2  -> Loi khi su dung nut bam
     GPIO_KEY3,        // GPIO10 Button 3
     0,                // Flash connection
     GPIO_REL1,        // GPIO12 Red Led and Relay 1 (0 = Off, 1 = On)
     GPIO_LED1_INV,    // GPIO13 Blue Led (0 = On, 1 = Off)
  ...
  { "MD SW8CH V1.0",  // Switch 08Ch - Minh Duyen (ESP8286)
     GPIO_KEY1,        // GPIO00 Button 1
     GPIO_REL6,        // GPIO01 Serial RXD and Optional sensor
     GPIO_USER,        // GPIO02 Optional sensor
     GPIO_REL7,        // GPIO03 Serial TXD and Optional sensor
     GPIO_REL3,        // GPIO04 Sonoff 4CH Red Led and Relay 3 (0 = Off, 1 = On)
     GPIO_REL2,        // GPIO05 Sonoff 4CH Red Led and Relay 2 (0 = Off, 1 = On)
     0, 0, 0,          // Flash connection
     0,        // GPIO09 Button 2  -> Loi khi su dung nut bam
     GPIO_REL8,        // GPIO10 Button 3
     0,                // Flash connection
     GPIO_REL1,        // GPIO12 Red Led and Relay 1 (0 = Off, 1 = On)
     GPIO_LED1_INV,    // GPIO13 Blue Led (0 = On, 1 = Off)
     GPIO_REL5,        // GPIO14 Button 4
     GPIO_REL4,        // GPIO15 Red Led and Relay 4 (0 = Off, 1 = On)
     0, 0
  },
  ...
  { "AiLight",         // Ai-Thinker RGBW led (ESP8266 - my9291 - Đèn mầu 1 bóng)
     GPIO_KEY1,        // GPIO00 Pad
     GPIO_USER,        // GPIO01 Serial RXD and Optional sensor pad
     GPIO_USER,        // GPIO02 Optional sensor SDA pad
     GPIO_USER,        // GPIO03 Serial TXD and Optional sensor pad
...
/*
  ...
  { "GM SW4CH V1.0",       // Bộ sitch không dây GAMMA 4Ch _Ver.1 (NodeMCU ESP-12E) Out 14 12 13 3  In 2 4 5 1
     GPIO_USER,        // GPIO00 Button 1 //Trùng GPIO2
     GPIO_KEY4,        // GPIO01 Serial RXD and Optional sensor
     GPIO_KEY1,        // GPIO02 Button 1
     GPIO_REL4,        // GPIO03 
     GPIO_KEY2,        // GPIO04 
     GPIO_KEY3,        // GPIO05 
     0, 0, 0,          // Flash connection (6, 7, 8)
     GPIO_USER, GPIO_USER, GPIO_USER,          // 9, 10,11
     GPIO_REL2,        // GPIO12 Red Led and Relay 1 (0 = Off, 1 = On)
     GPIO_REL3,       // GPIO13 Blue Led (0 = On, 1 = Off)
     GPIO_REL1,        // GPIO14 Button 4
     GPIO_LED1_INV,    // GPIO15 Blue Led trạng thái (0 = On, 1 = Off)
     0, 0
  },
