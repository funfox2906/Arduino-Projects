...
// -- Project -------------------------------------
#define PROJECT                "WifiDevice"          // PROJECT is used as the default topic delimiter
...
#define STA_SSID1              "AfonHOME"                  // [Ssid1] Wifi SSID
#define STA_PASS1              "0101010101"                // [Password1] Wifi password
#define STA_SSID2              "BMTL-Inter"                // [Ssid2] Optional alternate AP Wifi SSID
#define STA_PASS2              "BOMONTENLUA2015"                // [Password2] Optional alternate AP Wifi password
...
#define FRIENDLY_NAME          "Channel"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
// -- Location ------------------------------------
#define LATITUDE               21.027800         // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              105.8342000         // [Longitude] Your location to be used with sunrise and sunset
...
/*********************************************************************************************\
 * Select KNX without Emulation to save space //****** Biên dịch sử dụng KNX !!!!
\*********************************************************************************************/
